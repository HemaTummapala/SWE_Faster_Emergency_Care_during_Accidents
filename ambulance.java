...
e1=(EditText)findViewById(R.id.addambulancedrivername); 
e2=(EditText)findViewById(R.id.addambulanceEmail); 
e3=(EditText)findViewById(R.id.addambulanceMobile); 
e4=(EditText)findViewById(R.id.addambulanceDescription); 
e5=(EditText)findViewById(R.id.addambulanceAddress); 
...
Toast.makeText(getApplicationContext(), "Invalid Mobile", 
...
Toast.makeText(getApplicationContext(),"Ambulance Added 
